    ...
    () => {
      command match {
        ...
        case "installUpdates" =>
          ...
          val clientDistribution = new DistributionClientInterface(config.clientDistributionUrl)
        ...
        case "getDesiredVersions" =>
          ...
          val clientDistribution = new DistributionClientInterface(clientDistributionUrl)
