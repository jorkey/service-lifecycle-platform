...
- _payload:ServiceState_
  ...
  - _service_ - название сервиса
  - _directory_ - рабочий каталог серввиса
...
_Consumer_ периодически отправляет _provider_-у информацию об установленных сервисах _provider_-а:
...
Если определены сервисы для разработки, откройте _Build/Client_, иначе _Build_. 
Покажется таблица сервисов и их версий. В таблице отображаются версии сервисов какого-то из
серверов дистрибуции. 
