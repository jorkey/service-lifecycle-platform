...
Можно изменить желаемые версии разработчика или собственные желаемые клиентские версии, например,
если нужно откатить неудачно установленную версию.
Для этого нужно нажать на иконку редактирования в заголовке соответствующей колонки.

После внесения изменений, следует ожидать изменения версий справа.
