...
Последовательно выполняются команды _installCommands_, с предварительно выполненными 
расширениями макросов:
- _role_ - роль сервиса
- _version_ - версия разработчика

Каталог сборки копируется в рабочий каталог.

Последовательно выполняются команды _postInstallCommands_, с предварительно выполненными
расширениями макросов:
- _role_ - роль сервиса
- _version_ - версия разработчика
...
Выполняется команда _runService_, с предварительно выполненными расширениями макросов:
- _role_ - роль сервиса
- _version_ - версия разработчика
...
в каталог на локальном диске по указанным правилам.
