...
- Version, Author, Time, Comment - последняя версия, автор и время генерации сервиса
- Status
...
- Provider Version - версия сервиса у поставщика
- Developer Version - установленная версия разработчика
- Client Version - установленная версия клиента
