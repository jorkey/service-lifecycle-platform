...
Можно откатить неудачно установленное обновление, или несколько последних обновлений.
...
##### Откат версий разработчика

Выбирается список желаемых версий разработчика нужной редакции.
Далее производится обновление клиентских версий, либо вручную, либо автоматически, 
если задана опция _autoUpdate_. 

##### Откат версий клиента

Выбирается список желаемых версий клиента нужной редакции.
Далее _updater_-ы выполняют обновление версий клиентских инстанций.
