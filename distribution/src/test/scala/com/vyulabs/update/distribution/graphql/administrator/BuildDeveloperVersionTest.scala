...
class BuildDeveloperVersionTest extends TestEnvironment {
  ...
  it should "build developer version" in {
    ...
    logInput.requestNext()
    logInput.requestNext(
      ServerSentEvent("""{"data":{"subscribeTaskLogs":{"sequence":9,"logLine":{"line":{"level":"INFO","message":"Logger `Build developer version 1.1.1 of service service1` finished successfully"}}}}}"""))
