...
import com.vyulabs.update.info.{BuildVersionInfo, ClientDesiredVersions, DesiredVersions, DesiredVersionsMap, ServiceVersion, VersionInfo}
...
import distribution.graphql.GraphqlSchema.DesiredVersionsArg
