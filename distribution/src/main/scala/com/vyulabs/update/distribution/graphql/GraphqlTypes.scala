...
object GraphqlTypes {
  ...
  implicit val ClientVersionsInProcessInfoType = deriveObjectType[Unit, ClientVersionsInProcessInfo]()
  ...
  implicit val SequencedLogLineType = deriveObjectType[Unit, SequencedLogLine]()
