...
case class ServerUserInfo(user: UserId, human: Boolean, name: String, passwordHash: PasswordHash,
                          roles: Seq[String], email: Option[String], notifications: Seq[String])
