...
object GraphqlSchema {
  ...
  def Queries(implicit executionContext: ExecutionContext, log: Logger) = ObjectType(
    ...
    fields[GraphqlContext, Unit](
      ...
      Field("logMinTime", OptionType(DateType),
        arguments = OptionServiceArg :: OptionInstanceArg :: OptionDirectoryArg :: OptionProcessArg :: OptionTaskArg :: Nil,
        resolve = c => { c.ctx.workspace.getLogMinTime(c.arg(OptionServiceArg), c.arg(OptionInstanceArg),
          c.arg(OptionDirectoryArg), c.arg(OptionProcessArg), c.arg(OptionTaskArg)) }),
      Field("logMaxTime", OptionType(DateType),
        arguments = OptionServiceArg :: OptionInstanceArg :: OptionDirectoryArg :: OptionProcessArg :: OptionTaskArg :: Nil,
        resolve = c => { c.ctx.workspace.getLogMaxTime(c.arg(OptionServiceArg), c.arg(OptionInstanceArg),
          c.arg(OptionDirectoryArg), c.arg(OptionProcessArg), c.arg(OptionTaskArg)) }),
