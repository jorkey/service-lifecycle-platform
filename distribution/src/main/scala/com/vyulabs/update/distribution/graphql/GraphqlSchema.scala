...
object GraphqlSchema {
  ...
  val DeveloperVersionArg = Argument("version", VersionType)
  val ClientVersionArg = Argument("version", ClientVersionInputType)
  val DeveloperDistributionVersionArg = Argument("version", DistributionVersionInputType)
  val ClientDistributionVersionArg = Argument("version", ClientDistributionVersionInputType)
  val DeveloperDistributionVersionUniqueArg = Argument("developerVersion", DistributionVersionInputType)
  ...
  val OptionDeveloperVersionArg = Argument("version", OptionInputType(VersionType))
