...
case class ServerBuildClientServiceState(service: ServiceId, author: AccountId,
                                         version: DeveloperDistributionVersion, taskId: TaskId, state: String)

case class TimedBuildClientServiceState(time: Date, service: ServiceId, author: AccountId, version: DeveloperDistributionVersion, taskId: TaskId, state: BuildState)
